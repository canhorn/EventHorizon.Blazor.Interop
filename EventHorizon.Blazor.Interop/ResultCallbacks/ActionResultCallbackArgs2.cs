namespace EventHorizon.Blazor.Interop.ResultCallbacks
{
    ...
    public class ActionResultCallback<TArg1, TArg2, TResult>
    {
        /// <summary>
        ...
        /// </summary>
        public DotNetObjectReference<ActionResultCallback<TArg1, TArg2, TResult>> invokableReference { get; }
        /// <summary>
        ...
        private Func<TArg1, TArg2, TResult> _callback;
        ...
        public ActionResultCallback(
            Func<TArg1, TArg2, TResult> callback
        )
        {
            _callback = callback;
        ...
        [JSInvokable]
        public TResult HandleCallback(TArg1 arg1, TArg2 arg2)
        {
