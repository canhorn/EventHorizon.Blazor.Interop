namespace EventHorizon.Blazor.Interop.ResultCallbacks
{
    ...
    public class ActionResultCallback<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>
    {
        /// <summary>
        ...
        /// </summary>
        public DotNetObjectReference<ActionResultCallback<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>> invokableReference { get; }
        /// <summary>
        ...
        private Func<TArg1, TArg2, TArg3, TArg4, TArg5, TResult> _callback;
        ...
        public ActionResultCallback(
            Func<TArg1, TArg2, TArg3, TArg4, TArg5, TResult> callback
        )
        {
            _callback = callback;
        ...
        [JSInvokable]
        public TResult HandleCallback(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5)
        {
